    ...
    <div className="container">
      <div className="row">
        <div className="col-12 border-bottom">
          <h1 className="my-3">Róbert Darida</h1>
        </div>

        <div className="col-12 border-bottom">
          <h2 className="my-3">Hi there 👋</h2>
        </div>
        ...
        <div className="col-12">
          ...
          <p>
            ...
            <br />
            🎓 I graduated with BSc in Computer Science from University of
            Szeged.
            <br />
        ...
        <div className="col-12" hidden>
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
            >
              Building a NodeJS project and deploying it into a DigitalOcean
              Droplet with Jenkins
            </a>
          </p>
        </div>
        ...
        <div className="col-12">
          ...
          <ul>
            <li>
              <a
                href="https://github.com/rdarida/lerna-templater/"
                target="_blank"
              >
                <b>lerna-templater</b>
              </a>
        ...
        <div className="col-12">
          <h3 className="my-3">🛠 Tech Stack</h3>
          <p>
            <Badge logo="HTML5" />
